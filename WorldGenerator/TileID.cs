...
public static class TileID
{
    public static class Sets
    {
        ...
        public static SetFactory Factory = new SetFactory((int)TileIDs.Count/*TileLoader.TileCount*/);
        ...
        //
        // Summary:
        //     Allows non-solid tiles to be sloped (solid tiles can always be sloped, regardless
        //     of this set).
        public static bool[] CanBeSloped = Factory.CreateBoolSet();

        //
        // Summary:
        //     Whether or not the tile will be ignored for automatic step up regarding town
        //     NPC collision.
        //     Only checked when Terraria.Collision.StepUp(Microsoft.Xna.Framework.Vector2@,Microsoft.Xna.Framework.Vector2@,System.Int32,System.Int32,System.Single@,System.Single@,System.Int32,System.Boolean,System.Int32)
        //     with specialChecksMode set to 1 is called
        public static bool[] IgnoredByNpcStepUp = Factory.CreateBoolSet(14, 16, 18, 134, 469);

        //
        // Summary:
        //     Whether or not the smart cursor function is disabled when the cursor hovers above
        //     this tile.
        ...
        //
        // Summary:
        //     Whether or not the smart tile interaction function is disabled when the cursor
        //     hovers above this tile.
        ...
        //
        // Summary:
        //     Whether or not this tile behaves like a torch. If you are making a torch tile,
        //     then setting this to true is necessary in order for tile placement, tile framing,
        //     and the item's smart selection to work properly.
        ...
        //
        // Summary:
        //     Whether or not this tile is a sapling, which can grow into a tree based on the
        //     soil it's placed on. Be sure to set Terraria.ID.TileID.Sets.CommonSapling with
        //     this too.
        ...
        //
        // Remarks:
        //     Note: This Set does not include the values within the Sets Terraria.ID.TileID.Sets.BasicChest,
        //     Terraria.ID.TileID.Sets.BasicChestFake, and Terraria.ID.TileID.Sets.BasicDresser,
        //     but Tile IDs within those sets will also prevent sandfall.
        public static bool[] PreventsSandfall = Factory.CreateBoolSet(26, 77, 80, 323, 470, 475, 597);

        //
        // Summary:
        //     What tiles count as Pylons, which allow the player to teleport to any other valid
        //     Pylons on the map.
